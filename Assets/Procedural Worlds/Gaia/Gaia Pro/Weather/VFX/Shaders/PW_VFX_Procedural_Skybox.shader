...
Shader "PWS_TEST/ProceduralSkybox"
{
	Properties
	{
		_FogColor("FogColor", Color) = (0.9137255,0.8509804,0.7215686,0)
		_SunDiskSize("Sun Disk Size", Range( 4 , 2048)) = 0
		_SunAuraSize("SunAuraSize", Range( 4 , 512)) = 0
		_SunEdge("Sun Edge", Range( 0 , 0.88)) = 0.867
		_SunEdgeSoftness("SunEdgeSoftness", Range( 0 , 0.25)) = 0.093
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform float _SunAuraSize;
			uniform float _SunEdge;
			uniform float _SunEdgeSoftness;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 appendResult358 = (float3(ase_worldViewDir.x , ase_worldViewDir.y , ase_worldViewDir.z));
				float dotResult12 = dot( -worldSpaceLightDir , appendResult358 );
				...
				float temp_output_63_0 = ( ( ( 1.0 - HorizonScaleDayNight304 ) * HorizonGlowGlobalScale307 ) * saturate( pow( ( 1.0 - abs( dotResult40 ) ) , _HorizonSharpness ) ) * saturate( ( pow( ( 1.0 - clampResult14 ) , 5.0 ) * _HorizonGlowIntensity * ( 1.0 - clampResult89 ) ) ) );
				float4 HorizonColor313 = _FogColor;
				float TotalHorizonMask314 = temp_output_63_0;
				...
				float smoothstepResult261 = smoothstep( 0.0 , 1.0 , pow( dotResult265 , _SunAuraSize ));
				float smoothstepResult369 = smoothstep( _SunEdge , ( _SunEdge + _SunEdgeSoftness ) , pow( dotResult265 , _SunDiskSize ));
				...
				#endif //aselc
				float3 SunDisk203 = ( saturate( ( ( ( smoothstepResult261 * 0.15 ) + smoothstepResult369 ) * pow( saturate( dotResult302 ) , 3.0 ) ) ) * ase_lightColor.a * ase_lightColor.rgb * 2.0 );
				float4 Sky175 = ( temp_output_63_0 + float4( ( pow( ( ( HorizonColor313.rgb * temp_output_2_0_g1 ) + appendResult7_g1 ) , temp_cast_1 ) * SunDisk203 ) , 0.0 ) + ( temp_output_63_0 * _FogColor ) );
...
/*ASEBEGIN
Version=16700
7;26;1906;993;2011.387;1212.443;1.477573;True;False
Node;AmplifyShaderEditor.CommentaryNode;205;-4328.524,-1856.158;Float;False;2352.849;723.3484;Comment;27;75;203;71;18;69;200;12;34;11;10;261;265;252;298;300;302;303;359;360;358;369;370;371;374;372;376;377;Sun Disk;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;206;-4306.389,-1003.857;Float;False;4121.021;1625.509;Comment;16;198;57;175;76;55;63;233;234;305;309;311;313;314;316;356;378;Horizon And Sun Glow;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;11;-4322.402,-1339.139;Float;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;10;-4327.306,-1490.535;Float;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;358;-3973.329,-1359.123;Float;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1740.65,-1378.857;Float;False;Property;_NightTransitionScale;Night Transition Scale;12;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;34;-3968.77,-1511.789;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-4229.824,122.2515;Float;False;Property;_HorizonSunGlowSpreadMax;Horizon Sun Glow Spread Max;10;0;Create;True;0;0;False;0;0;1.3;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-4219.824,33.2516;Float;False;Property;_HorizonSunGlowSpreadMin;Horizon Sun Glow Spread Min;9;0;Create;True;0;0;False;0;5.075109;2.83;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DotProductOpNode;12;-3795.802,-1438.868;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-4295.005,-2060.831;Float;False;Property;_NightTransitionHorizonDelay;Night Transition Horizon Delay;13;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;200;-3643.339,-1419.139;Float;False;InvVDotL;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;75;-3430.093,-1410.278;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;265;-3284.322,-1419.34;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;376;-4309.682,-1819.653;Float;False;Property;_SunAuraSize;SunAuraSize;4;0;Create;True;0;0;False;0;0;28;4;512;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;-1918.605,-2095.759;Float;False;Property;_HorizonMinAmountAlways;Horizon Min Amount Always;14;0;Create;True;0;0;False;0;0;0.584;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-4304.591,-1674.573;Float;False;Property;_SunEdgeSoftness;SunEdgeSoftness;6;0;Create;True;0;0;False;0;0.093;0;0;0.25;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;300;-3197.954,-1226.726;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.AbsOpNode;44;-3571.094,-457.9051;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;370;-4311.591,-1612.573;Float;False;Property;_SunEdge;Sun Edge;5;0;Create;True;0;0;False;0;0.867;0.586;0;0.88;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;252;-4312.656,-1741.189;Float;False;Property;_SunDiskSize;Sun Disk Size;3;0;Create;True;0;0;False;0;0;69;4;2048;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;377;-3462.568,-1653.112;Float;False;2;0;FLOAT;0;False;1;FLOAT;64;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-3514.3,-367.9907;Float;False;Property;_HorizonSharpness;Horizon Sharpness;8;0;Create;True;0;0;False;0;5.7;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-2870.218,66.3748;Float;False;Property;_HorizonGlowIntensity;Horizon Glow Intensity;7;0;Create;True;0;0;False;0;0.59;0.71;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;261;-3136.77,-1829.142;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;360;-3730.485,-1750.729;Float;False;2;0;FLOAT;0;False;1;FLOAT;64;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;372;-3092.513,-1488.073;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;369;-3137.321,-1666.804;Float;False;3;0;FLOAT;0;False;1;FLOAT;0.85;False;2;FLOAT;0.855;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;374;-2839.786,-1842.757;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0.15;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;375;-2827.681,-1713.653;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;359;-2767.707,-1428.465;Float;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;59;-2969.237,-465.6631;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-1944.266,-590.8991;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;57;-2035.794,-413.3345;Float;False;Property;_FogColor;FogColor;1;0;Create;True;0;0;False;0;0.9137255,0.8509804,0.7215686,0;1,0.4602997,0.3537736,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightColorNode;18;-2583.491,-1557.06;Float;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SaturateNode;69;-2504.536,-1662.316;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;362;-2353.897,-1430.511;Float;False;Constant;_Float3;Float 3;12;0;Create;True;0;0;False;0;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;-2337.559,-1658.418;Float;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;312;-1827,31.13788;Float;False;313;HorizonColor;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;315;-1837.013,99.3501;Float;False;314;TotalHorizonMask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;291;-1846.931,201.4503;Float;False;Property;_HorizonTintSunPower;Horizon Tint Sun Power;11;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;378;-1478.282,-430.2081;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;76;-883.8889,-648.9993;Float;False;3;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;79;-725.8815,-1587.034;Float;False;Property;_NightColor;Night Color;2;0;Create;True;0;0;False;0;0,0,0,0;0.1415088,0.1368363,0.1368363,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;198;-1556.107,-936.3846;Float;False;197;SkyColor;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;56;-735.8195,-1766.734;Float;False;Property;_SkyColor;Sky Color;0;0;Create;True;0;0;False;0;0.3764706,0.6039216,1,0;0.2216981,0.5791668,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;39;132.271,-911.8556;Float;False;True;2;Float;ASEMaterialInspector;0;1;PWS_TEST/ProceduralSkybox;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;True;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;True;0;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
WireConnection;358;0;11;1
WireConnection;358;1;11;2
WireConnection;358;2;11;3
WireConnection;34;0;10;0
WireConnection;235;0;86;0
WireConnection;12;0;34;0
WireConnection;12;1;358;0
...
WireConnection;377;0;265;0
WireConnection;377;1;376;0
WireConnection;90;0;89;0
WireConnection;307;0;223;0
WireConnection;47;0;44;0
WireConnection;261;0;377;0
WireConnection;360;0;265;0
WireConnection;360;1;252;0
...
WireConnection;378;0;63;0
WireConnection;378;1;57;0
WireConnection;76;0;63;0
WireConnection;76;1;288;0
WireConnection;76;2;378;0
...
ASEEND*/
//CHKSM=6DA9270F1CE79177D2290FEC483781F2F10B0BEB